...
select EmployeeGovernmentID, count(EmployeeGovernmentID) as MyCount from tblEmployee3
group by EmployeeGovernmentID
having count(EmployeeGovernmentID)>1

select * from tblEmployee3 where EmployeeGovernmentID IN ('HN513777D', 'TX593671R')

begin tran
delete from tblEmployee3
where EmployeeNumber < 3

delete top(2) from tblEmployee3
